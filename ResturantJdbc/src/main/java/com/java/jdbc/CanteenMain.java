...
public class CanteenMain {
	...
	public static void searchRestaurant() throws ClassNotFoundException, SQLException {
		...
		rid = sc.nextInt();
		Resturant restaurant = new ResturantDao().searchResturant(rid);
		System.out.println(restaurant);
	}
	public static void showRestaurant() {
		try {
			List<Resturant> restaurantList = new ResturantDao().showResturant();
	...
	public static void showMenu() {
		...
		public static void showCustomer() {
			try {
				List<Customer1> customer1List;
				customer1List = new Customer1DAO().showCustomer1();
				for (Customer1 customer : customer1List) {
		...
		public static void searchCustomer() throws ClassNotFoundException, SQLException {
			int customerid;
			System.out.println("Insert Customer1 Id   ");
			customerid = sc.nextInt();
			Customer1 customer = new Customer1DAO().searchcustomer1(customerid);
			System.out.println(customer);
		}
		public static void searchWalletbycid() throws ClassNotFoundException, SQLException {
			int customerid;
			System.out.println("Enter customer1 Id to search wallet  ");
			customerid = sc.nextInt();
			List<Wallet> wallet = new WalletDAO().searchByCustomer1Id(customerid);
